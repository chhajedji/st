 ...
 */
static char *font = "Noto Mono:size=12:antialias=true:autohint=true";
 ...
 */
const unsigned int mousescrollincrement = 5;    /* Mouse scrollback speed. */
...
static char *openurlcmd[] = { "/bin/sh", "-c",
	"xurls | dmenu -l 10 -w $WINDOWID | xargs -r dopeopen",
	"externalpipe", NULL };
